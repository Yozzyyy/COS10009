...
class Cell
  ...
  # has pointers to the neighboring cells
  ...
  def initialize()
    ...
    @vacant = false # vacant cell, true or false
    # this stops cycles - set when you travel through a cell
    @visited = false # visited during pathfinding?
    @on_path = false
  end
end
...
class GameWindow < Gosu::Window
  ...
  def initialize
    ...
    x_cell_count = MAP_WIDTH / CELL_DIM   #count
  ...
  # we cover Recursion in the lectures.
